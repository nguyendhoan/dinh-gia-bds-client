        ...
        tbody > {
            ...
            allUsers.map(
                ...
                item.status && ( <
                    ...
                    /span> <
                    /td> <
                    td className = 'p-4 px-6 text-xs align-middle border-t-0 border-l-0 border-r-0 whitespace-nowrap' > { item.username } <
                    /td> <
                    td className = 'p-4 px-6 text-xs align-middle border-t-0 border-l-0 border-r-0 whitespace-nowrap' > < /td>

                    <
                    td className = 'p-4 px-6 text-xs align-middle border-t-0 border-l-0 border-r-0 whitespace-nowrap' > { item.role == 0 ? 'admin' : 'member' } <
                    /td>
                    ...
                    <
                    TableUserDropdown active = { activeDropdown === index }
                    onToggle = {
                        () =>
                        setActiveDropdown(
