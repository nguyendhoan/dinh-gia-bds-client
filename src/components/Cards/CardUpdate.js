...
function CardUpdate({ record }) {
  ...
  const [getProvinceCode] = useFetch('http://localhost:3002/provinces')
  ...
  const updateRecord = async (id, allInput) => {
    try {
      if (allInput) {
        const res = await fetch(`http://localhost:3002/real_estate/${id}`, {
          method: 'PUT',
          headers: {
                ...
                <div className='relative flex justify-between w-full mb-3'>
                  <div className='w-full'>
                    ...
                    <input
                      ...
                      onChange={(e) => handletDienTichDatChange(e)}
                    />
                  </div>
                  <div className='w-full'>
                    <label
                    ...
                    <input
                      ...
                      onChange={(e) => handleChieuDaiChange(e)}
                    />
                  </div>
                  <div className='w-full'>
                    <label
                    ...
                    <input
                      ...
                      onChange={(e) => handleChieuRongChange(e)}
                    />
                  </div>
                </div>
              </div>
              ...
              <div className='flex w-full px-4 lg:w-6/12'>
                <div className='w-full mb-3'>
                  ...
                  >
                    ...
                    <option
                      selected={recordItem && recordItem.vi_tri == 0}
                      value={0}
                    >
                      Mặt tiền
                    </option>
                    <option
                      selected={recordItem && recordItem.vi_tri == 1}
                      value={1}
                    >
                      Hẻm
                    </option>
              ...
              <div className='w-full px-4 lg:w-full'>
                <div className='relative w-full mb-3'>
                  ...
                  <textarea
                    ...
                    value={inputMoTaDat}
                    onChange={(e) => handleMoTaDatChange(e)}
                  />
                </div>
              </div>
            </div>
              ...
              <div className='w-full px-4 lg:w-6/12'>
                <div className='relative w-full mb-3'>
                  ...
                  >
                    ...
                    <option
                      selected={recordItem && recordItem.loai_tai_san == '0'}
                      value='0'
                    >
                      Nhà ở
                    </option>
                    <option
                      selected={recordItem && recordItem.loai_tai_san == '1'}
                      value='1'
                    >
                      Văn phòng
                    </option>
                    <option
                      selected={recordItem && recordItem.loai_tai_san == '2'}
                      value='2'
                    >
                ...
                <div className='relative flex justify-between w-full mb-3'>
                  <div className='w-full'>
                    ...
                    <input
                      ...
                      onChange={(e) => handleDienTichXayDungChange(e)}
                    />
                  </div>
                  <div className='w-full'>
                    <label
                    ...
                    <input
                      ...
                      onChange={(e) => handleChieuDaiNhaChange(e)}
                    />
                  </div>
                  <div className='w-full'>
                    <label
                    ...
                    <input
                      ...
                      onChange={(e) => handleChieuRongNhaChange(e)}
                    />
                  </div>
                </div>
              </div>
              ...
              <div className='w-full px-4 lg:w-6/12'>
                <div className='relative w-full mb-3'>
                  ...
                  <input
                    ...
                    placeholder='0'
                    value={inputSoSan}
                    onChange={(e) => handleSoSanChange(e)}
                  />
                </div>
              </div>
              <div className='w-full px-4 lg:w-full'>
              ...
              <div className='flex justify-between w-full mb-3'>
                <div className='w--18'>
                  ...
                  <input
                    ...
                    onChange={(e) => handleGiaoDichChange(e)}
                  />
                </div>
                <div className='w--18'>
                  <label
                  ...
                  <input
                    ...
                    placeholder='0'
                    value={inputRaoBan}
                    onChange={(e) => handleRaoBanChange(e)}
                  />
                </div>
                <div className='w--18'>
                  <label
                  ...
                  <input
                    ...
                    onChange={(e) => handleTaiSanGanLienChange(e)}
                  />
                </div>
                <div className='w--18'>
                  <label
                ...
                <div className='w--18'>
                  ...
                  <input
                    ...
                    placeholder='0'
                    value={tongGiaTri}
                    onChange={(e) => handleTongGiaTriChange(e)}
                  />
                </div>
              </div>
            </div>
                  ...
                  >
                    ...
                    {getDistricts ?
                      getDistricts.data.map((item, index) => (
                        <option
                          selected={recordItem.quan == item.code}
                          key={index}
                          value={item.code}
                        >
                          {item.name}
                  ...
                  >
                    ...
                    {getWards &&
                      getWards.data.map((item, index) => (
                        <option
                          selected={recordItem.phuong == item.code}
                          key={index}
                          value={item.code}
                        >
                          {item.name}
              ...
              <div className='w-full px-4 lg:w-12/12'>
                <div className='relative w-full mb-3'>
                  ...
                  <textarea
                    ...
                    rows='10'
                    value={nhanDinh}
                    onChange={(e) => handleNhanDinhChange(e)}
                  ></textarea>
                </div>
              </div>
            </div>
